...
forktest(void)
{
  ...
  34:	3f050513          	addi	a0,a0,1008 # 420 <symlink+0xe>
  ...
  56:	41e50513          	addi	a0,a0,1054 # 470 <symlink+0x5e>
  ...
  6c:	3c850513          	addi	a0,a0,968 # 430 <symlink+0x1e>
  ...
  7e:	3ce50513          	addi	a0,a0,974 # 448 <symlink+0x36>
  ...
  ae:	3b650513          	addi	a0,a0,950 # 460 <symlink+0x4e>
